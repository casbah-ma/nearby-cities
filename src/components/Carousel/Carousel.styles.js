...
export const CarouselDots = tw.div`p-3 flex items-center justify-center rounded-full gap-2 bg-[rgba(29, 29, 29, 0.8)] shadow-[2px 4px 16px rgba(0, 0, 0, 0.16)] 
absolute mx-[5rem] lg:mx-[12.5rem] left-0 right-0 bottom-10  lg:bottom-5 z-20`;
